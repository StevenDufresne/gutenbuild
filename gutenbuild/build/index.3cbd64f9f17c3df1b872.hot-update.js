...
function DataTabProvider(_ref) {
  ...
  for (let k = 0; k < storeNames.length; k++) {
    ...
    allData = allData.concat(flatten({
      [`wp.data.select(${store})`]: wp.data.select(store)
    }));
  }
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "cc08d9dc82a61acc1a17"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=index.3cbd64f9f17c3df1b872.hot-update.js.map