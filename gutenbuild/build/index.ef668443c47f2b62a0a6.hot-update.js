...
const getDocLink = (lib, prop, type) => {
  ...
  if (lib.startsWith('data')) {
    ...
    if (storeName) {
      console.log(getDocModule(storeName));
      return `https://developer.wordpress.org/block-editor/reference-guides/data/data-core${getDocModule(storeName)}/`;
    }
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "10490bb844f6b0dd9884"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=index.ef668443c47f2b62a0a6.hot-update.js.map