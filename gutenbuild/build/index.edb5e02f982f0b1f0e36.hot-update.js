...
const cleanLib = lib => lib.split(/(?=[A-Z])/).join('-');
...
const getDocLink = (lib, prop, type) => {
  ...
  let link = `https://developer.wordpress.org/block-editor/reference-guides/packages/packages-${lib.toLowerCase()}`; // data.select('core')
  // if() {
  // }
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "782c1d2f4985c09d05b5"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=index.edb5e02f982f0b1f0e36.hot-update.js.map