...
const getDocLink = (lib, prop) => {
  switch (lib) {
    case 'components':
      return `https://wordpress.github.io/gutenberg/?path=/story/components-${prop}`;
  } //
  //return `https://developer.wordpress.org/block-editor/reference-guides/data/data-core${ lib }`;


  return `https://developer.wordpress.org/block-editor/reference-guides/packages//packages-${lib}`;
};
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "61a8cefefadce6b6e18a"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=index.8cd00ec16f8211c2c4ec.hot-update.js.map