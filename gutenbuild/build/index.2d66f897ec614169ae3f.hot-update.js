...
const runFunction = i => {
  ...
  if (lib.startsWith('data')) {
    if (func.startsWith('select')) {
      debugger;
      wp['data']['select'](cleanLib(i.text));
    } else {
      wp['data']['dispatch'](cleanLib(i.text));
    }
  } else {
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "b608cec7a41c34f40cbc"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=index.2d66f897ec614169ae3f.hot-update.js.map