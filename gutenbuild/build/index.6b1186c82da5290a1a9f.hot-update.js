...
const flatten = obj => {
  ...
  for (var key in obj) {
    for (var prop in obj[key]) {
      out.push(`${key.toLowerCase()}.${prop.toLowerCase()}`);
    }
  }
...
function DataTabProvider(_ref) {
  ...
  const search = keyword => {
    ...
    return allData.filter(i => i.includes(keyword.toLowerCase()));
  };
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "eb41cff511a6d767a389"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=index.6b1186c82da5290a1a9f.hot-update.js.map