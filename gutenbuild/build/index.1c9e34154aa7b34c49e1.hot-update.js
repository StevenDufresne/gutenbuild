...
function DataTabProvider(_ref) {
  ...
  for (let k = 0; k < storeNames.length; k++) {
    ...
    allData = allData.concat(flatten({
      [`wp.data.dispatch(${store})`]: wp.data.dispatch(store)
    }));
  }
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "963f27d4469e5a6faec5"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=index.1c9e34154aa7b34c49e1.hot-update.js.map