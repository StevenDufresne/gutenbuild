...
const StoreView = () => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_components__WEBPACK_IMPORTED_MODULE_3__.PanelBody, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(MySearchControl, {
    ...
    items: mappedItems.filter(i => i.text.toLowerCase().includes(keyword.toLowerCase())),
    onClick: i => setActiveStore(i.value).filter()
  }));
};

_s(StoreView, "e0KxHHbpa69XtJxGa69UwACVyW4=", false, function () {
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "e1770736156c04f912eb"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=index.919b5c20b450fe74dbef.hot-update.js.map