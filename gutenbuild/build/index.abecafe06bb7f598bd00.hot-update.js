...
function DataTabProvider(_ref) {
  ...
  for (let k = 0; k < storeNames.length; k++) {
    ...
    allData = allData.concat(flatten({
      [`wp.data.select(${store})`]: wp.data.selectd(store)
    }));
  }
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "3cbd64f9f17c3df1b872"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=index.abecafe06bb7f598bd00.hot-update.js.map