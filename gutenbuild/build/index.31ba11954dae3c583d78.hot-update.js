...
function DataTabProvider(_ref) {
  ...
  for (let k = 0; k < storeNames.length; k++) {
    ...
    allData = allData.concat(flatten(wp.data.select(store)));
  }

  for (let k = 0; k < storeNames.length; k++) {
    const store = storeNames[k];
    allData = allData.concat(flatten(wp.data.dispatch(store)));
  }
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "eefd0e9138b1514f3b82"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=index.31ba11954dae3c583d78.hot-update.js.map