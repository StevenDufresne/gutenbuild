...
const flatten = obj => {
  ...
  for (var key in obj) {
    ...
    if (Object.keys(obj[key]).length.forEach) {
      console.log('oin each');
      Object.keys(obj[key]).length.forEach(prop => {
        out.push(`${key}.${prop}`);
      });
    }
  }
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "9712fb1cb890bc9d4e4d"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=index.7625eadb2fdbd3776d02.hot-update.js.map