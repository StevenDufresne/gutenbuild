...
function DataTabProvider(_ref) {
  ...
  for (let k = 0; k < storeNames.length; k++) {
    ...
    allData = allData.concat(flatten({
      [`wp.data.select(${store})`]: wp.data.dispatch(store)
    }));
  }
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "1c9e34154aa7b34c49e1"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=index.af39f4ce701ca9ecccbb.hot-update.js.map