...
const getDocLink = (lib, prop, type) => {
  ...
  let link = `https://developer.wordpress.org/block-editor/reference-guides/packages/packages-${lib}`;

  if (type === 'function') {
    return `${link}${lib}/#${prop}`;
  }
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "1a42eb26df2956df7e8e"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=index.5de520d7854b9be9382a.hot-update.js.map