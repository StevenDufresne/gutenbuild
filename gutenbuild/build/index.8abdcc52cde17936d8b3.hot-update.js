...
const flatten = obj => {
  ...
  for (var i in obj) {
    ...
    if (typeof obj[i] == 'object' && obj[i] !== null) {
      ...
      for (var j in flat) {
        if (!flat.hasOwnProperty(j)) continue;
        out[i + '.' + x] = flat[j];
      }
    } else {
      out[i] = obj[i];
...
/******/ !function() {
/******/ 	__webpack_require__.h = function() { return "47e7ea72f00a55ccd583"; }
/******/ }();
/******/ 
/******/ }
);
//# sourceMappingURL=index.8abdcc52cde17936d8b3.hot-update.js.map